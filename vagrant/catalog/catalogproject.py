...
def newItem(category_id):
    ...
    if login_session['user_id'] != category.user_id:
        return "<script>function myFunc() {alert('You are not authorized to add menu items to this');}</script><body onload='myFunc()'>";
...
def editItem(category_id, item_id):
    ...
    if editedItem.user_id != login_session['user_id']:
        return "<script>function myFunc() {alert('You are not authorized to edit this item');}</script><body onload='myFunc()'>"
    if request.method == 'POST':
...
def deleteItem(category_id, item_id):
    ...
    if login_session['user_id'] != itemToDelete.user_id:
        return "<script>function myFunc() {alert('You are not authorized to delete menu items.');}</script><body onload='myFunc()'>"
    if request.method == 'POST':
